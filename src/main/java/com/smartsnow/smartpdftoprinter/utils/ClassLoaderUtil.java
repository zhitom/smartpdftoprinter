...
public class ClassLoaderUtil {
	...
	private ClassLoader[] classLoaderList = new ClassLoader[5];
	...
	/*
	 * Find a class on the classpath, starting with a specific classloader (or die
	 * trying)
	 *
	 * @param name - the class to look for
	 * 
	 ...
	 * @return the class
	 * 
	 * @throws ClassNotFoundException - Remember the wisdom of Judge Smails: Well,
	...
	private ClassLoader[] getClassLoaders(ClassLoader classLoader) {
		classLoaderList[0] = classLoader;
		classLoaderList[1] = defaultClassLoader;
		classLoaderList[2] = Thread.currentThread().getContextClassLoader();
		classLoaderList[3] = getClass().getClassLoader();
		classLoaderList[4] = systemClassLoader;
